...
uint64_t RainbowChainWalk::m_plainText     = 0x305532286D6F295A;
unsigned char RainbowChainWalk::m_dplainText[8] = {0x6D,0x6F,0x29,0x5A,0x30,0x55,0x32,0x28};
...
void RainbowChainWalk::SetChainInfo(uint64_t chainLen, uint64_t chainCount)
{
    m_chainLen   = chainLen;
...
void RainbowChainWalk::CipherToKey(unsigned char * out)
{
